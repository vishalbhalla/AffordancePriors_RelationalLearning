...
def startJvm():
    ...
    os.environ.setdefault("STANFORD_PARSER_HOME", "/home/vishal/Statistical\ Relational\ Learning/Affordance Mining/AffordancePriors_RelationalLearning/AffordancePriors_RelationalLearning/3rdParty/stanford-parser/stanford-parser-2010-08-20")
    ...
    # jpype.startJVM("/usr/lib/jvm/java-7-openjdk-amd64/jre/lib/amd64/server/libjvm.so",
    #                "-ea",
    #                "-Djava.class.path=%s/stanford-parser.jar" % (stanford_parser_home),)

    jpype.startJVM("/usr/lib/jvm/java-7-openjdk-amd64/jre/lib/amd64/server/libjvm.so",
                   "-ea",
                   "-Djava.class.path=/home/vishal/stanford-parser.jar",)
...
class Parser:
    ...
    def __init__(self, pcfg_model_fname=None):
        if pcfg_model_fname == None:
            ...
            self.pcfg_model_fname = "/home/vishal/englishPCFG.ser.gz"
        else:
